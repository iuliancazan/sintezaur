...
import { SLIDE_S00_00_HUB_SHORT } from './s00-00-hub-short';
import { SLIDE_S00_02_TODAY } from './s00-02-today';
import { SLIDE_S00_04_WHERE } from './s00-04-where-basic-program';
...
import { SLIDE_S02_03_WHERE } from './s02-03-where-octaves';
import { SLIDE_S02_04_PULSE_WIDTH } from './s02-04-pulse-width';
import { SLIDE_S02_04_WHERE } from './s02-04-where-pulse-width';
...
import { SLIDE_S03_02_WHERE } from './s03-02-where-cutoff';
import { SLIDE_S03_03_RESONANCE } from './s03-03-resonance';
import { SLIDE_S03_03_WHERE } from './s03-03-where-resonance';
import { SLIDE_S03_04_KEY_TRACK_AND_ENV_AMOUNT } from './s03-04-key-track-and-env-amount';
import { SLIDE_S03_04_WHERE } from './s03-04-where-key-track';
...
import { SLIDE_S04_02_WHERE } from './s04-02-where-amp-envelope';
import { SLIDE_S04_03_TWO_ENVELOPES } from './s04-03-two-envelopes';
import { SLIDE_S04_03_WHERE } from './s04-03-where-filter-envelope';
...
import { SLIDE_S05_02_WHERE } from './s05-02-where-lfo';
import { SLIDE_S05_03_THE_MODULATION_SECTION } from './s05-03-the-modulation-section';
import { SLIDE_S05_03_WHERE } from './s05-03-where-modulation';
...
import { SLIDE_S06_03_WHERE } from './s06-03-where-unison';
import { SLIDE_S06_04_CHORD_MEMORY } from './s06-04-chord-memory';
import { SLIDE_S06_04_WHERE } from './s06-04-where-chord-memory';
import { SLIDE_S06_05_FEEDBACK } from './s06-05-feedback';
import { SLIDE_S06_05_WHERE } from './s06-05-where-feedback';
...
import { SLIDE_S07_02_WHERE } from './s07-02-where-velocity';
import { SLIDE_S07_03_POLY_AT } from './s07-03-poly-at';
import { SLIDE_S07_04_AT_ROUTING } from './s07-04-at-routing';
import { SLIDE_S07_04_WHERE } from './s07-04-where-aftertouch';
...
import { SLIDE_S08_02_WHERE } from './s08-02-where-arpeggiator';
...
import { SLIDE_S09_01_THE_ROAD_AGAIN_SHORT } from './s09-01-the-road-again-short';
 ...
 * "…·W" slides are the Where-on-Fourm focus slides (where-on-fourm.ts): each
 * sits right after the content slide whose demo it supports.
 */
 ...
 * the course map and "The road, again" show six nodes.
 */
export const SLIDES_SHORT: SlideDef[] = [
  SLIDE_S00_00_HUB_SHORT,
  SLIDE_S00_02_TODAY,
  SLIDE_S00_04_WHERE,
  SLIDE_S01_01_COVER,
  SLIDE_S01_03_VOICE_PATH,
  ...
  SLIDE_S06_05_WHERE,
  SLIDE_S06_06_TERMS,
  SLIDE_S09_01_THE_ROAD_AGAIN_SHORT,
  SLIDE_S09_02_THANK_YOU,
  SLIDE_SAX_01_COVER,
];
