...
export const CHEAT_ROWS: CheatRow[] = [
  ...
  },
  {
    ...
    theyDo: { en: `From Basic Program (hold <strong>transpose down</strong> + <strong>program</strong>), rebuild the bass from 04: A builds, B checks against the handbook, page 09; then the other way. Settings get written down.`, ro: `Din Basic Program (hold <strong>transpose down</strong> + <strong>program</strong>), reconstruiți bass-ul de la 04: A construiește, B verifică în manual, pagina 09; apoi invers. Pozițiile se notează.` },
    who: { en: `A → swap → B`, ro: `A → swap → B` },
  },
];
