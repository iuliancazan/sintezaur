...
export const BEFORE_DOORS: L[] = [
  ...
  { en: `student handbooks (EN + RO) by the exit, not on the tables; water; photo/video.`, ro: `manualele cursantului (EN + RO) la ieșire, nu pe mese; apă; foto/video.` },
...
export const TRAPS: L[] = [
  { en: `<strong>If you hear nothing:</strong> headphones plugged into the splitter? <strong>main</strong> at 12 o&#x27;clock? at least one mixer source up? <strong>cutoff</strong> closed? an amount left at 12 o&#x27;clock (= zero)? <strong>key track</strong> off while playing high? Last resort: Basic Program — hold <strong>transpose down</strong> + <strong>program</strong>.`, ro: `<strong>Dacă nu auzi nimic:</strong> căștile în splitter? <strong>main</strong> la 12 o&#x27;clock? în mixer cel puțin o sursă sus? <strong>cutoff</strong> închis? un amount lăsat la 12 o&#x27;clock (= zero)? <strong>key track</strong> off și cânți sus? Ultima soluție: Basic Program — hold <strong>transpose down</strong> + <strong>program</strong>.` },
  ...
  { en: `<strong>The amounts are bipolar</strong> (MODULATION and <strong>env amt</strong>): 12 o&#x27;clock = nothing. Say &#x201C;from twelve toward the right&#x201D;, never just &#x201C;raise the amount&#x201D;.`, ro: `<strong>Amount-urile sunt bipolare</strong> (MODULATION și <strong>env amt</strong>): 12 o&#x27;clock = nimic. Spune „de la douăsprezece spre dreapta”, niciodată doar „ridică amount-ul”.` },
  ...
  { en: `<strong><strong>program</strong> without <strong>transpose down</strong></strong> switches the preset and loses the sound they built. Remind them at every exercise.`, ro: `<strong><strong>program</strong> fără <strong>transpose down</strong></strong> schimbă presetul și pierde sunetul construit. Reamintește la fiecare exercițiu.` },
...
export const CHEAT_ROWS: CheatRow[] = [
  ...
  },
  {
    ...
    theyDo: { en: `A · BASS: AMP ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 · <strong>sustain</strong> 8 · <strong>release</strong> 8 o&#x27;clock; FILTER ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 · <strong>sustain</strong> min · <strong>release</strong> 8; FILTER <strong>env amt</strong> 3 o&#x27;clock · <strong>cutoff</strong> 9 o&#x27;clock; short notes; then FILTER ENV <strong>decay</strong> shorter. B · PAD: AMP ENV <strong>attack</strong> 12 · <strong>decay</strong> 0 · <strong>sustain</strong> max · <strong>release</strong> 2 o&#x27;clock; <strong>cutoff</strong> 12 · <strong>env amt</strong> 10 o&#x27;clock; Osc B <strong>saw</strong>, octave 0, <strong>frequency</strong> slightly off-centre; held chord. Good settings get written into the handbook, page 04.`, ro: `A · BASS: AMP ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 · <strong>sustain</strong> 8 · <strong>release</strong> 8 o&#x27;clock; FILTER ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 · <strong>sustain</strong> min · <strong>release</strong> 8; FILTER <strong>env amt</strong> 3 o&#x27;clock · <strong>cutoff</strong> 9 o&#x27;clock; note scurte; apoi FILTER ENV <strong>decay</strong> mai scurt. B · PAD: AMP ENV <strong>attack</strong> 12 · <strong>decay</strong> 0 · <strong>sustain</strong> max · <strong>release</strong> 2 o&#x27;clock; <strong>cutoff</strong> 12 · <strong>env amt</strong> 10 o&#x27;clock; Osc B <strong>saw</strong>, octave 0, <strong>frequency</strong> ușor off-centre; acord ținut. Pozițiile bune se notează în manual, pagina 04.` },
    who: { en: `A bass → swap → B pad`, ro: `A bass → swap → B pad` },
  },
  {
    beat: '05·04',
    module: { en: `05 · LFO &amp; MODULATION`, ro: `05 · LFO &amp; MODULATION` },
    theyDo: { en: `A: LFO <strong>triangle</strong> on, <strong>frequency</strong> 10 o&#x27;clock → MODULATION <strong>route</strong> (LFO) ×2 = blue → <strong>freq a</strong> ×2, <strong>freq b</strong> ×2 → LFO <strong>amount</strong> from 12 o&#x27;clock to the right → mod wheel up. B: <strong>freq a</strong> / <strong>freq b</strong> until dark → <strong>pw a</strong> ×2 → plays; then <strong>cutoff</strong> ×2 → <strong>frequency</strong> and <strong>amount</strong> higher, then back.`, ro: `A: LFO <strong>triangle</strong> on, <strong>frequency</strong> 10 o&#x27;clock → MODULATION <strong>route</strong> (LFO) ×2 = albastru → <strong>freq a</strong> ×2, <strong>freq b</strong> ×2 → LFO <strong>amount</strong> de la 12 o&#x27;clock spre dreapta → mod wheel sus. B: <strong>freq a</strong> / <strong>freq b</strong> până se sting → <strong>pw a</strong> ×2 → cântă; apoi <strong>cutoff</strong> ×2 → <strong>frequency</strong> și <strong>amount</strong> mai sus, apoi înapoi.` },
    who: { en: `A → swap → B`, ro: `A → swap → B` },
  },
  {
    beat: '06·06',
  ...
  },
  {
    ...
    theyDo: { en: `From Basic Program (hold <strong>transpose down</strong> + <strong>program</strong>), rebuild the bass from 04: A builds, B checks against the handbook, page 04; then the other way. Settings get written down.`, ro: `Din Basic Program (hold <strong>transpose down</strong> + <strong>program</strong>), reconstruiți bass-ul de la 04: A construiește, B verifică în manual, pagina 04; apoi invers. Pozițiile se notează.` },
    who: { en: `A → swap → B`, ro: `A → swap → B` },
  },
];
