...
const SHORT: VariantCut = {
  ...
  sayPrefix: {
    '02·02': {
      ...
      ro: `„Întâi un lucru: o notă nu e niciodată un singur ton. E o fundamentală plus un turn de armonice mai încete, iar amestecul lor e ceea ce numim timbru — despre asta e tot jocul de azi."`,
    },
  },
  patch: {
    ...
    '02·07': {
      say: {
        en: `&#x201C;Headphones on, from Basic Program. Osc A: press PULSE, so both saw and pulse are lit. Hold PULSE and turn SELECT toward the edge, then back. Osc B: press TRI, octave to minus one, raise OSC B in the mixer — put the sub in, take it out, feel the weight. Nudge B&#x27;s FREQUENCY a little off center and listen to the beats; too far and it splits into two notes — bring it back. Swap halfway.&#x201D;`,
        ro: `„Căștile sus, din Basic Program. Osc A: apăsați PULSE, să fie aprinse și saw și pulse. Țineți PULSE și rotiți SELECT spre margine, apoi înapoi. Osc B: apăsați TRI, octava la minus unu, ridicați OSC B din mixer — puneți sub-ul, scoateți-l, simțiți greutatea. Mișcați FREQUENCY-ul lui B puțin de la centru și ascultați bătăile; prea mult și se despart în două note — aduceți-l înapoi. Schimbați la jumătate."`,
      },
      theyDo: {
    ...
    '03·05': {
      say: {
        en: `&#x201C;Headphones on. Hold a chord. Cutoff slowly down until it&#x27;s dark, then back. Resonance to three o&#x27;clock and one more sweep: the whistle rides the sweep. Now, careful: bring MAIN down a little, resonance to maximum, close the cutoff a bit and play single notes — the filter sings on its own. To finish: resonance back to nine o&#x27;clock, cutoff to twelve — we keep this for the next module. Swap in the middle.&#x201D;`,
        ro: `„Căștile sus. Țineți un acord. Cutoff încet în jos până e întunecat, apoi înapoi. Rezonanța la ora trei și încă un sweep: fluieratul călărește sweep-ul. Acum, atenție: coborâți puțin MAIN, rezonanța la maximum, închideți cutoff-ul un pic și cântați note simple — filtrul cântă singur. La final: rezonanța înapoi la ora nouă, cutoff la ora douăsprezece — păstrăm asta pentru modulul următor. Schimbați la mijloc."`,
      },
      theyDo: {
    ...
    '04·05': {
      say: {
        en: `&#x201C;Headphones on, and this time we all build the same thing: the bass, from the module 2 sound. Amp envelope — attack zero, decay ten o&#x27;clock, sustain eight o&#x27;clock, release eight o&#x27;clock. Filter envelope — attack zero, decay ten o&#x27;clock, sustain minimum, release eight o&#x27;clock. In the filter: ENV AMT to three o&#x27;clock — from twelve toward the right! — and cutoff at nine o&#x27;clock. Short notes, low. Then shorten the filter decay: more pluck. Swap halfway. The pad recipe is in your handbook, page 04 — build that one at home.&#x201D;`,
        ro: `„Căștile sus, și de data asta construim toți același lucru: bass-ul, din sunetul de la modulul 2. Amp envelope — attack zero, decay ora zece, sustain ora opt, release ora opt. Filter envelope — attack zero, decay ora zece, sustain minim, release ora opt. În filtru: ENV AMT la ora trei — de la douăsprezece spre dreapta! — și cutoff la ora nouă. Note scurte, jos. Apoi scurtați decay-ul filtrului: mai mult pluck. Schimbați la jumătate. Rețeta de pad e în manual, la pagina 04 — pe aia o faceți acasă."`,
      },
      theyDo: {
        en: `(A) BASS: AMP ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> 8 o&#x27;clock · <strong>release</strong> 8 o&#x27;clock; FILTER ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> min · <strong>release</strong> 8 o&#x27;clock; FILTER <strong>env amt</strong> 3 o&#x27;clock · <strong>cutoff</strong> 9 o&#x27;clock; short notes; then FILTER ENV <strong>decay</strong> shorter. Swap; (B) the same. Note the positions you liked in the student handbook, page 04.`,
        ro: `(A) BASS: AMP ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> 8 o&#x27;clock · <strong>release</strong> 8 o&#x27;clock; FILTER ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> min · <strong>release</strong> 8 o&#x27;clock; FILTER <strong>env amt</strong> 3 o&#x27;clock · <strong>cutoff</strong> 9 o&#x27;clock; note scurte; apoi FILTER ENV <strong>decay</strong> mai scurt. Swap; (B) la fel. Notați în manualul cursantului, la pagina 04, pozițiile care v-au plăcut.`,
      },
    },
    ...
    '09·04': {
      say: {
        en: `&#x201C;Thank you. Zeedo, thank you for making this possible; Sequential, thank you for the instruments. On your way out you&#x27;ll get the student handbook, in English or Romanian: the same diagrams, all the theory — including the two modules we didn&#x27;t play tonight. You&#x27;ll find us at Sintezaur — [where] — and that&#x27;s where we announce the next workshop. Until then: the synths are yours for another four minutes.&#x201D;`,
        ro: `„Mulțumesc. Zeedo, mulțumim că ați făcut asta posibil; Sequential, mulțumim pentru instrumente. La plecare primiți manualul cursantului, în engleză sau română: aceleași diagrame, toată teoria — inclusiv cele două module pe care nu le-am cântat în seara asta. Ne găsiți la Sintezaur — [unde] — și acolo anunțăm următorul workshop. Până atunci: synth-urile sunt ale voastre încă patru minute."`,
      },
    },
    '09·05': {
      say: {
