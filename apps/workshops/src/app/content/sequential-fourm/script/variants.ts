...
const SHORT: VariantCut = {
  ...
  patch: {
    ...
    '03·05': {
      ...
      theyDo: {
        en: `<strong>cutoff</strong> down → up; <strong>resonance</strong> at 3 o&#x27;clock, sweep → <strong>main</strong> slightly down → <strong>resonance</strong> max → <strong>cutoff</strong> a bit closed → single notes; then <strong>resonance</strong> to 9 o&#x27;clock, <strong>cutoff</strong> to 12 o&#x27;clock.`,
        ro: `<strong>cutoff</strong> jos → sus; <strong>resonance</strong> la 3 o&#x27;clock, sweep → <strong>main</strong> puțin jos → <strong>resonance</strong> max → <strong>cutoff</strong> puțin închis → note simple; apoi <strong>resonance</strong> la 9 o&#x27;clock, <strong>cutoff</strong> la 12 o&#x27;clock.`,
      },
    },
    // Three minutes: everyone builds the bass; the pad stays in the handbook.
    '04·05': {
      say: {
        en: `&#x201C;Headphones on, and this time we all build the same thing: the bass, from the module 2 sound. Amp envelope: attack zero, decay ten o&#x27;clock, sustain eight o&#x27;clock, release eight o&#x27;clock. Filter envelope: attack zero, decay ten o&#x27;clock, sustain minimum, release eight o&#x27;clock. In the filter: ENV AMT to three o&#x27;clock, from twelve toward the right!, and cutoff at nine o&#x27;clock. Short notes, low. Then shorten the filter decay: more pluck. The pad recipe is in your handbook, page 09; build that one at home.&#x201D;`,
        ro: `„Căștile sus, și de data asta construim toți același lucru: bass-ul, din sunetul de la modulul 2. Amp envelope: attack zero, decay ora zece, sustain ora opt, release ora opt. Filter envelope: attack zero, decay ora zece, sustain minim, release ora opt. În filtru: ENV AMT la ora trei, de la douăsprezece spre dreapta!, și cutoff la ora nouă. Note scurte, jos. Apoi scurtați decay-ul filtrului: mai mult pluck. Rețeta de pad e în manual, la pagina 09; pe aia o faceți acasă."`,
      },
      theyDo: {
        en: `BASS: AMP ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> 8 o&#x27;clock · <strong>release</strong> 8 o&#x27;clock; FILTER ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> min · <strong>release</strong> 8 o&#x27;clock; FILTER <strong>env amt</strong> 3 o&#x27;clock · <strong>cutoff</strong> 9 o&#x27;clock; short notes; then FILTER ENV <strong>decay</strong> shorter. Note the positions you liked, or photograph the panel.`,
        ro: `BASS: AMP ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> 8 o&#x27;clock · <strong>release</strong> 8 o&#x27;clock; FILTER ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> min · <strong>release</strong> 8 o&#x27;clock; FILTER <strong>env amt</strong> 3 o&#x27;clock · <strong>cutoff</strong> 9 o&#x27;clock; note scurte; apoi FILTER ENV <strong>decay</strong> mai scurt. Notați-vă pozițiile care v-au plăcut, sau faceți-i o poză panoului.`,
      },
    },
