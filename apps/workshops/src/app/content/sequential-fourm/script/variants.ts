...
const SHORT: VariantCut = {
  ...
  patch: {
    ...
    '04·05': {
      say: {
        en: `&#x201C;Headphones on, and this time we all build the same thing: the bass, from the module 2 sound. Amp envelope — attack zero, decay ten o&#x27;clock, sustain eight o&#x27;clock, release eight o&#x27;clock. Filter envelope — attack zero, decay ten o&#x27;clock, sustain minimum, release eight o&#x27;clock. In the filter: ENV AMT to three o&#x27;clock — from twelve toward the right! — and cutoff at nine o&#x27;clock. Short notes, low. Then shorten the filter decay: more pluck. Swap halfway. The pad recipe is in your handbook, page 06 — build that one at home.&#x201D;`,
        ro: `„Căștile sus, și de data asta construim toți același lucru: bass-ul, din sunetul de la modulul 2. Amp envelope — attack zero, decay ora zece, sustain ora opt, release ora opt. Filter envelope — attack zero, decay ora zece, sustain minim, release ora opt. În filtru: ENV AMT la ora trei — de la douăsprezece spre dreapta! — și cutoff la ora nouă. Note scurte, jos. Apoi scurtați decay-ul filtrului: mai mult pluck. Schimbați la jumătate. Rețeta de pad e în manual, la pagina 06 — pe aia o faceți acasă."`,
      },
      theyDo: {
        en: `(A) BASS: AMP ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> 8 o&#x27;clock · <strong>release</strong> 8 o&#x27;clock; FILTER ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> min · <strong>release</strong> 8 o&#x27;clock; FILTER <strong>env amt</strong> 3 o&#x27;clock · <strong>cutoff</strong> 9 o&#x27;clock; short notes; then FILTER ENV <strong>decay</strong> shorter. Swap; (B) the same. Note the positions you liked in the student handbook, page 06.`,
        ro: `(A) BASS: AMP ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> 8 o&#x27;clock · <strong>release</strong> 8 o&#x27;clock; FILTER ENV <strong>attack</strong> 0 · <strong>decay</strong> 10 o&#x27;clock · <strong>sustain</strong> min · <strong>release</strong> 8 o&#x27;clock; FILTER <strong>env amt</strong> 3 o&#x27;clock · <strong>cutoff</strong> 9 o&#x27;clock; note scurte; apoi FILTER ENV <strong>decay</strong> mai scurt. Swap; (B) la fel. Notați în manualul cursantului, la pagina 06, pozițiile care v-au plăcut.`,
      },
    },
